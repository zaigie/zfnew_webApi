    ...
    if request.method == 'POST':
        ...
        try:
            ...
            if choosed == None:
                ...
                return HttpResponse(json.dumps(nchoosed,ensure_ascii=False),content_type="application/json,charset=utf-8")
            else:
            ...
            print(e)
            requests.get('https://sc.ftqq.com/SCU48704T2fe1a554a1d0472f34720486b88fc76e5cb0a8960e8be.send?text=已选课程未知错误&desp=' + str(e) + '\n' + str(xh) + '\n' + str(pswd))
    else:
